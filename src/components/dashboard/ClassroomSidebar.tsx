    ...
    <Sidebar className="border-r border-vr-light-gray">
      <SidebarHeader className="flex items-center h-16 px-4 border-b border-vr-light-gray">
        <h1 className="text-xl font-bold text-white flex items-center gap-2">
          <span className="text-vr-purple">VR</span>
      ...
      <SidebarContent className="py-4">
        <div className="mb-4 px-4">
          <h2 className="text-sm font-medium text-sidebar-foreground mb-2">Classrooms</h2>
        </div>
            ...
            <button
              ...
              className={cn(
                ...
                selectedClassroom === classroom.id
                  ? "bg-vr-purple text-white"
                  : "text-sidebar-foreground hover:bg-vr-light-purple hover:text-vr-purple"
              )}
            >
      ...
      <SidebarFooter className="border-t border-vr-light-gray p-4">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 rounded-full bg-vr-light-purple flex items-center justify-center text-vr-purple">
            T
          </div>
          <div>
